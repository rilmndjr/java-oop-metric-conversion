...
public class DegreesCelsiustoFahrenheit extends JFrame implements ActionListener
{
	...
	public DegreesCelsiustoFahrenheit(JFrame frame1)
	{
		super("Degrees Celsius to Fahrenheit");
		fr = frame1;
		con = getContentPane();
		con.setLayout(null);
		
		lbl_number = new JLabel("Celsius: ");
		lbl_value = new JLabel("Fahrenheit: ");
