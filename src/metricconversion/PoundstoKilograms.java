...
public class PoundstoKilograms extends JFrame implements ActionListener
{
	...
	public PoundstoKilograms(JFrame frame1)
	{
		super("Pounds to Kilogram");
		
		fr = frame1;
		con = getContentPane();
		con.setLayout(null);
		
		lbl_number = new JLabel("Pounds: ");
		lbl_value = new JLabel("Kilograms: ");
