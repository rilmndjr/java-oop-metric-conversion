...
public class FeettoMeter extends JFrame implements ActionListener
{
	...
	public FeettoMeter(JFrame frame1)
	{
		super("Feet to Meter");
		...
		lbl_number = new JLabel("Feet: ");
		lbl_value = new JLabel("Meter: ");
